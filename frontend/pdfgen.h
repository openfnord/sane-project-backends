...
/**
 * Add a Pixels data as an image to the document
 * @param pdf PDF document to add Pixels to
 * @param page Page to add Pixels to (NULL => most recently added page)
 * @param x X offset to put pixels at
 * @param y Y offset to put pixels at
 ...
 * @param pixels data to display
 * @return < 0 on failure, >= 0 on success
 */
int pdf_add_pixels (struct pdf_doc *pdf, struct pdf_object *page, float x,
